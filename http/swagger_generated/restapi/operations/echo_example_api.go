...
func NewEchoExampleAPI(spec *loads.Document) *EchoExampleAPI {
	return &EchoExampleAPI{
		...
		ProductsCreateProductHandler: products.CreateProductHandlerFunc(func(params products.CreateProductParams) middleware.Responder {
			return middleware.NotImplemented("operation products.CreateProduct has not yet been implemented")
		}),
		ProductsDeleteProductHandler: products.DeleteProductHandlerFunc(func(params products.DeleteProductParams) middleware.Responder {
			return middleware.NotImplemented("operation products.DeleteProduct has not yet been implemented")
		}),
		FilesDownloadFileHandler: files.DownloadFileHandlerFunc(func(params files.DownloadFileParams) middleware.Responder {
			return middleware.NotImplemented("operation files.DownloadFile has not yet been implemented")
		}),
		ProductsGetProductHandler: products.GetProductHandlerFunc(func(params products.GetProductParams) middleware.Responder {
			return middleware.NotImplemented("operation products.GetProduct has not yet been implemented")
		}),
		ProductsListProductsHandler: products.ListProductsHandlerFunc(func(params products.ListProductsParams) middleware.Responder {
			return middleware.NotImplemented("operation products.ListProducts has not yet been implemented")
		}),
		ProductsUpdateProductHandler: products.UpdateProductHandlerFunc(func(params products.UpdateProductParams) middleware.Responder {
...
type EchoExampleAPI struct {
	...
	// ProductsCreateProductHandler sets the operation handler for the create product operation
	ProductsCreateProductHandler products.CreateProductHandler
	// ProductsDeleteProductHandler sets the operation handler for the delete product operation
	ProductsDeleteProductHandler products.DeleteProductHandler
	...
	// ProductsGetProductHandler sets the operation handler for the get product operation
	ProductsGetProductHandler products.GetProductHandler
	// ProductsListProductsHandler sets the operation handler for the list products operation
	ProductsListProductsHandler products.ListProductsHandler
	// ProductsUpdateProductHandler sets the operation handler for the update product operation
	ProductsUpdateProductHandler products.UpdateProductHandler
...
func (o *EchoExampleAPI) Validate() error {
	...
	if o.ProductsCreateProductHandler == nil {
		unregistered = append(unregistered, "products.CreateProductHandler")
	}
	if o.ProductsDeleteProductHandler == nil {
		unregistered = append(unregistered, "products.DeleteProductHandler")
	}
	if o.FilesDownloadFileHandler == nil {
		unregistered = append(unregistered, "files.DownloadFileHandler")
	}
	if o.ProductsGetProductHandler == nil {
		unregistered = append(unregistered, "products.GetProductHandler")
	}
	if o.ProductsListProductsHandler == nil {
		unregistered = append(unregistered, "products.ListProductsHandler")
	}
	if o.ProductsUpdateProductHandler == nil {
		unregistered = append(unregistered, "products.UpdateProductHandler")
	}
...
func (o *EchoExampleAPI) initHandlerCache() {
	...
	o.handlers["POST"]["/products"] = products.NewCreateProduct(o.context, o.ProductsCreateProductHandler)
	if o.handlers["DELETE"] == nil {
		o.handlers["DELETE"] = make(map[string]http.Handler)
	}
	o.handlers["DELETE"]["/products/{id}"] = products.NewDeleteProduct(o.context, o.ProductsDeleteProductHandler)
	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
	o.handlers["GET"]["/file"] = files.NewDownloadFile(o.context, o.FilesDownloadFileHandler)
	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
	o.handlers["GET"]["/products/{id}"] = products.NewGetProduct(o.context, o.ProductsGetProductHandler)
	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
	o.handlers["GET"]["/products"] = products.NewListProducts(o.context, o.ProductsListProductsHandler)
	if o.handlers["PUT"] == nil {
		o.handlers["PUT"] = make(map[string]http.Handler)
	}
	o.handlers["PUT"]["/products/{id}"] = products.NewUpdateProduct(o.context, o.ProductsUpdateProductHandler)
}
